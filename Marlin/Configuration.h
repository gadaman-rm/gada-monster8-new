...
#define STRING_CONFIG_H_AUTHOR "(Ranjbar, GI80)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "GADA3D GI80"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 1600, 195.24 }
